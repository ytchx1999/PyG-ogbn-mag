...
def process_adj(data):
    ...
    e_idx = data.edge_index_dict[('paper', 'cites', 'paper')]
    num_nodes = data.num_nodes_dict['paper']
    e_idx = to_undirected(e_idx, num_nodes)
...
for run in range(args.runs):
    ...
    for epoch in range(1, 1 + args.epochs):
        ...
        # train_acc, val_acc, test_acc, out = result
    ...
    y_train = data.y_dict['paper'][train_idx].to(device)
